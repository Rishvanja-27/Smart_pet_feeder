...
//
const char *SSID     = "Siddardha"; // Enter your Wi-Fi name 
const char *PASSWORD = "Siddu@0802" ; // Enter your Wi-Fi password
//
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
// ====================================================================
...
char* const inputToken  = "petfeed";
char* const outputToken = "petfeed";
...
void setup() {
    ...
    uint32_t baudRateSet = 9600;
    Serial.begin(baudRateSet);
    Serial.println("start");
    
    if (!wifi.init(SSID, PASSWORD,baudRateSet))
    {
